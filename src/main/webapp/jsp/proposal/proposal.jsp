            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th><fmt:message key="proposal.isArchived" bundle="${rb}"/></th>
                ...
                <tbody>
                    ...
                    <h4 class="text-center">
                        <fmt:message key="message.noProposal" bundle="${rb}"/>
                    </h4>
                </c:if>
                <tr>
                    ...
                    <td>
                        <c:if test="${not empty proposal.filePath}">
                    ...
                    <td><label><input type="checkbox" disabled="disabled" <c:if test="${proposal.isArchived}">checked="checked"</c:if>></label></td>
                    <td><c:out value="${proposal.user.getLogin()}"/></td>
