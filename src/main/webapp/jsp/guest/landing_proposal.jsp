...
<body class="w3-green">
    ...
    <c:set var="lastPage" value="/jsp/guest/landing_proposal.jsp" scope="session" />
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <h2><fmt:message key="message.landing.21" bundle="${rb}"/></h2>
                <p><fmt:message key="message.landing.22" bundle="${rb}"/></p>
                <p><fmt:message key="message.landing.23" bundle="${rb}"/></p>
                <p><fmt:message key="message.landing.24" bundle="${rb}"/></p>
            </div>
        </div>
    </div>
